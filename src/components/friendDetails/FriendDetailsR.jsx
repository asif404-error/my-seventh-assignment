      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            className="flex flex-col items-center gap-1 border border-gray-200 rounded-lg py-3 hover:bg-gray-50 active:scale-95 transition cursor-pointer text-sm text-gray-700"
          >
            <img src={call} alt="telephone-logo" className="size-8" />
            Call
          </button>
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 border border-gray-200 rounded-lg py-3 hover:bg-gray-50 active:scale-95 transition cursor-pointer text-sm text-gray-700"
          >
            <img src={text} alt="text-box" className="size-8" />
            Text
          </button>
          ...
          <button
            ...
            className="flex flex-col items-center gap-1 border border-gray-200 rounded-lg py-3 hover:bg-gray-50 active:scale-95 transition cursor-pointer text-sm text-gray-700"
          >
            <img src={video} alt="video-logo" className="size-8" />
            Video
          </button>
        </div>
      </div>
              ...
              <div key={item.id} className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  <div className="bg-gray-100 p-2 rounded-full">
                    {item.type === "Call" && (
                      <img src={call} alt="telephone-logo" className="size-6" />
                    )}
                    {item.type === "Text" && (
                      <img src={text} alt="text-box" className="size-6" />
                    )}
                    {item.type === "Video" && (
                      <img src={video} alt="video-logo" className="size-6" />
                    )}
                  </div>
